...
const CORE = [
  ...
  "json/quiz-cursos/civica.json","json/quiz-cursos/calculo.json","json/quiz-cursos/logica.json","json/quiz-cursos/actualidad.json","json/quiz-cursos/ingles.json"
];
