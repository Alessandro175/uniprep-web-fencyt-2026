(function () {
  ...
  async function renderizarTutor() {
    ...
    raiz.innerHTML = `<section class="tutor-head tutor-head-evolution"><div class="tutor-head-copy"><small>UNI · ASISTENTE ACADÉMICO</small><h1>${primerNombre ? `Hola, ${esc(primerNombre)}. ` : ""}Pregunta, analiza y aprende con criterio.</h1><p>Úsala para tareas, proyectos, redacción, ciencia, orientación o preparación preuniversitaria. Tú defines el objetivo; Uni responde con explicaciones, preguntas y práctica verificable.</p><div class="tutor-head-badges"><span>Consulta libre</span><span>Imagen y voz</span><span>Guía local de respaldo</span></div></div><div class="tutor-ai-orbit"><span>✦</span><i></i><i></i><i></i><div class="tutor-head-status"><b>Asistente disponible</b><em id="tutor-service-status">Comprobando servicio…</em></div></div></section>
